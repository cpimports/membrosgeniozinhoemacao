...
export const activities: Activity[] = [
  ...
  { id: '31', title: 'Historias', category: 'Alfabetização', thumbnailUrl: 'https://placehold.co/400x250.png', pdfUrl: 'https://drive.google.com/drive/u/4/folders/1hbv7gmSDPlYdAJvg65ucvpQ7SHIfaioh', isFavorite: false, aiHint: 'story time' },
  { id: '32', title: 'Fluência leitora', category: 'Alfabetização', thumbnailUrl: 'https://placehold.co/400x250.png', pdfUrl: 'https://drive.google.com/drive/u/4/folders/1uqwk0ZTh5Xe9g8fLWpeCSfKP7nGir1_d', isFavorite: false, aiHint: 'reading fluency' },
  { id: '33', title: 'Escrita maluca', category: 'Alfabetização', thumbnailUrl: 'https://placehold.co/400x250.png', pdfUrl: '#', isFavorite: false, aiHint: 'creative writing' },
  ...
  { id: '41', title: 'Cores e números', category: 'Matemática', thumbnailUrl: 'https://placehold.co/400x250.png', pdfUrl: '#', isFavorite: false, aiHint: 'colors numbers' },
